...
ALLOWED_HOSTS = ["*", "127.0.0.1", "localhost", "0.0.0.0", "4psy.club"]
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "Клуб <club@4psy.club>")

# App

APP_HOST = os.environ.get("APP_HOST") or "http://127.0.0.1:8000"
APP_NAME = "4psy.Клуб"
APP_DESCRIPTION = "Клуб для всех, кто интересуется психологией"
...
OG_MACHINE_AUTHOR_LOGO = "https://4psy.club/static/images/the_machine_logo.png"
OG_IMAGE_GENERATOR_DEFAULTS = {
    "logo": "https://4psy.club/static/images/logo/logo-white-text.png",
    "op": 0.6,
    "bg": "#FFFFFF",
}
...
TELEGRAM_BOT_WEBHOOK_URL = "https://4psy.club/telegram/webhook/"
...
DEFAULT_AVATAR = "https://i.4psy.club/v.png"
...
CLEARED_POST_TEXT = "```\n" \
    ...
    "Если вы хотите приютить и развить эту тему как новый автор, напишите модераторам Клуба: moderator@4psy.club." \
    "\n```"
