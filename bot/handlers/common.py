...
COMMENT_URL_RE = re.compile(r"https?://4psy.club/[a-zA-Z]+/.+?/#comment-([a-fA-F0-9\-]+)")
POST_URL_RE = re.compile(r"https?://4psy.club/[a-zA-Z]+/(.+?)/")
...
def get_club_user(update: Update):
    ...
    if not user:
        update.message.reply_text(
            f"😐 Привяжи <a href=\"https://4psy.club/user/me/edit/bot/\">бота</a> к профилю, братишка",
